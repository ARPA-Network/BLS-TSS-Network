...
parser.add_argument(
    "--deploy",
    help="Whether the contracts should be predeployed or deployed",
    type=bool,
...
def devnet_deploy(paths):
    ...
    devnet_cfg_orig = pjoin(
        paths.contracts_bedrock_dir, "deploy-config", "devnetL1.json"
    )
    ...
    if os.path.exists(paths.addresses_json_path):
        ...
        sdk_addresses["L1CrossDomainMessenger"] = addresses[
