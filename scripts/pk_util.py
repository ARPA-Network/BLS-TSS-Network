...
def print_keypair(mnemonic, index, passphrase=""):
    """Prints the private key and corresponding public key for a given mnemonic and derivation path."""

    str_derivation_path = f"m/44'/60'/0'/0/{index}"
    private_key = mnemonic_to_private_key(mnemonic, str_derivation_path, passphrase)
