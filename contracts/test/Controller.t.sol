...
contract ControllerTest is RandcastTestHelper {
    ...
    function testNodeRegister() public {
        ...
        vm.prank(_node1);
        _nodeRegistry.nodeRegister(_badKey, false, _emptyOperatorSignature);
        ...
        INodeRegistry.Node memory n = _nodeRegistry.getNode(_node1);
    ...
    function testRebalanceGroup() public {
        ...
        vm.prank(_node11);
        _nodeRegistry.nodeRegister(_dkgPubkey11, false, _emptyOperatorSignature);
        emit log("+++++++++++++++++++++++");
        printGroupInfo(0);
        printGroupInfo(1);
    ...
    function testPostProcessDkg() public {
        ...
        (, uint256 nodeArpaRewards) = _nodeRegistry.getNodeWithdrawableTokens(_node1);
