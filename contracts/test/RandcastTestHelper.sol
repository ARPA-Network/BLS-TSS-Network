...
abstract contract RandcastTestHelper is Test {
    ...
    address public node13 = address(0xD);
    address public node14 = address(0xE);
    address public node15 = address(0xF);
    address public node16 = address(0x10);
    address public node17 = address(0x11);
    address public node18 = address(0x12);
    address public node19 = address(0x13);
    address public node20 = address(0x14);
    address public node21 = address(0x15);
    address public node22 = address(0x16);
    address public node23 = address(0x17);
    address public node24 = address(0x18);
    address public node25 = address(0x19);
    address public node26 = address(0x1A);
    address public node27 = address(0x1B);
    address public node28 = address(0x1C);
    address public node29 = address(0x1D);
    address public node30 = address(0x1E);
    address public node31 = address(0x1F);
