...
contract ExtendedDKGScenarioTest is RandcastTestHelper {
    ...
    function test53NodeQuit() public {
        ...
        */
        ...
        params = new Params[](5);
        params[0] = Params(node1, false, err, 0, 6, publicKey, partialPublicKey5, new address[](0));
        params[1] = Params(node2, false, err, 0, 6, publicKey, partialPublicKey4, new address[](0));
        ...
        params[1] = Params(node5, false, err, 1, 5, publicKey, partialPublicKey1, new address[](0));
        params[2] = Params(node4, false, err, 1, 5, publicKey, partialPublicKey2, new address[](0));
        dkgHelper(params);
        ...
        params = new Params[](3);
        params[0] = Params(node1, false, err, 0, 7, publicKey, partialPublicKey9, new address[](0));
        params[1] = Params(node2, false, err, 0, 7, publicKey, partialPublicKey7, new address[](0));
        params[2] = Params(node3, false, err, 0, 7, publicKey, partialPublicKey3, new address[](0));
        dkgHelper(params);

        params = new Params[](4);
        params[0] = Params(node4, false, err, 1, 6, publicKey, partialPublicKey2, new address[](0));
        params[1] = Params(node5, false, err, 1, 6, publicKey, partialPublicKey1, new address[](0));
        params[2] = Params(node9, false, err, 1, 6, publicKey, partialPublicKey5, new address[](0));
        params[3] = Params(node7, false, err, 1, 6, publicKey, partialPublicKey4, new address[](0));
        dkgHelper(params);
