...
pub const FULFILL_RANDOMNESS_GAS_EXCEPT_CALLBACK: u64 = 620000;
pub const RANDOMNESS_REWARD_GAS: u64 = 9000;
pub const VERIFICATION_GAS_OVER_MINIMUM_THRESHOLD: u64 = 50000;
pub const DEFAULT_MINIMUM_THRESHOLD: u64 = 3;
